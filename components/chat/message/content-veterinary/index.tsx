import TagReceive from "../content/tag-receive";
import TagTransmitter from "../content/tag-transmitter";
import MessageImage from "../content/image";
...
export default function VeterinaryMessageContent({ openFile, setOpenFile } : Props) {
